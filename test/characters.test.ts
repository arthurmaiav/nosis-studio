...
describe("characters", () => {
  test("loads the recurring cast and its visual reference state", async () => {
    ...
    expect(result.characters.map((character) => ({
      ...
      { id: "marisol", "2d": "approved", "3d": "approved" },
      { id: "projectionist", "2d": "approved", "3d": "approved" },
      ...
      { id: "innkeeper", "2d": "approved", "3d": "approved" },
      { id: "midwife", "2d": "approved", "3d": "approved" },
      { id: "celebrant", "2d": "approved", "3d": "approved" },
      { id: "impresario", "2d": "approved", "3d": "approved" },
      { id: "polyglot", "2d": "approved", "3d": "approved" },
      { id: "gremlin", "2d": "approved", "3d": "approved" },
      { id: "tailor", "2d": "approved", "3d": "approved" },
      { id: "ada", "2d": "approved", "3d": "approved" },
      { id: "clara", "2d": "approved", "3d": "approved" },
      { id: "frank", "2d": "approved", "3d": "approved" },
      { id: "iris", "2d": "approved", "3d": "approved" },
      { id: "joe", "2d": "approved", "3d": "approved" },
      { id: "june", "2d": "approved", "3d": "approved" },
      { id: "nina", "2d": "approved", "3d": "approved" },
      { id: "otto", "2d": "approved", "3d": "approved" },
      { id: "peter", "2d": "approved", "3d": "approved" },
      { id: "ruth", "2d": "approved", "3d": "approved" },
      { id: "sam", "2d": "approved", "3d": "approved" },
      { id: "walter", "2d": "approved", "3d": "approved" }
    ]);
